...
<?php
    $pageTitle = "Add New Web Blog"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Web Blog</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="webblogs-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('webblogs.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-short_text-holder" class=" ">
                                                <textarea placeholder="Enter Short Text" id="ctrl-short_text" data-field="short_text"  rows="5" name="short_text" class=" form-control"><?php echo get_value('short_text') ?></textarea>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-image-holder" class=" ">
                                                <div class="dropzone required" input="#ctrl-image" fieldname="image" uploadurl="{{ url('fileuploader/upload/image') }}"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                    <input name="image" id="ctrl-image" data-field="image" required="" class="dropzone-input form-control" value="<?php echo get_value('image') ?>" type="text"  />
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-is_publish-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('is_publish', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
