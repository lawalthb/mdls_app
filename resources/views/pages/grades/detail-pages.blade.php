    ...
    <div class="master-detail-page card">
        <div class="card-header text-bold h5 p-3 mb-3">Grades Records</div>
        <div class="p-2">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a data-bs-toggle="tab" href="#examsheetperformances_<?php echo $page_id ?>" class="nav-link active">
                    Grade Exam Sheet Performances
                </a>
            </li>
        </ul>
    </div>
    <div class="tab-content">
        ...
        <div class=" ">
            <?php
                $params = ['grade_id' => $rec_id,'show_header' => false]; //new query param
                $query = array_merge(request()->query(), $params);
                $queryParams = http_build_query($query);
                $url = url("examsheetperformances/index/grade_id/$rec_id?$queryParams");
            ?>
