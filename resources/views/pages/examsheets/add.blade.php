                                        ...
                                        <div id="ctrl-director_approval-holder" class=" ">
                                            ...
                                            if (!empty($options)) {
                                                foreach ($options as $option) {
                                                    ...
                                                    $checked = Html::get_field_checked('director_approval', $value, examsettings('director_approve'));
                                            ?>
                                ...
                                <div>
                                    ...
                                    <template id="<?php echo $template_id ?>">
                                        ...
                                        <tr data-row="<?php echo $row ?>" class="input-row" v-for="(row, index) in rows" :key="index">
                                            <td>
                                                <div v-model="row.subject_id" id=" ctrl-subject_id-row<?php echo $row; ?>-holder" class=" ">
                                            ...
                                            <td>
                                                <div id="ctrl-ca_score-row<?php echo $row; ?>-holder" class=" ">
                                                    <input id="ctrl-ca_score-row<?php echo $row; ?>" data-field="ca_score" value="<?php echo get_value('ca_score', "0") ?>" type="number" placeholder="Enter Ca Score" min="0" max="40" step="0.1" v-model="row.ca_score" required="" name="examsheetperformances[<?php echo $row ?>][ca_score]" class="form-control " :id="'ctrl-ca_score-row' + index" @input="calculateTotal(index)" />
                                                </div>
                                            </td>
                                            <td>
                                                <div id="ctrl-exam_score-row<?php echo $row; ?>-holder" class=" ">
                                                    <input v-model="row.exam_score" id=" ctrl-exam_score-row<?php echo $row; ?>" data-field="exam_score" value="<?php echo get_value('exam_score', "0") ?>" type="number" placeholder="Enter Exam Score" min="0" max="60" step="0.1" required="" name="examsheetperformances[<?php echo $row ?>][exam_score]" class="form-control " :id="'ctrl-exam_score-row' + index" @input="calculateTotal(index)" />
                                                </div>
                                            </td>
                                            <td>
                                                <div id="ctrl-total-row<?php echo $row; ?>-holder" class=" ">
                                                    <input v-model="row.total" id="ctrl-total-row<?php echo $row; ?>" data-field="total" value="<?php echo get_value('total') ?>" type="number" placeholder="Enter Total" min="0" max="100" step="0.1" required="" name="examsheetperformances[<?php echo $row ?>][total]" class="form-control " :id="'ctrl-total-row' + index" readonly />
                                                </div>
                                            </td>
                                            <td>
