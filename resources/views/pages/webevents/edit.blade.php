...
<?php
    $pageTitle = "Edit Web Event"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Web Event</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("webevents/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-short_text-holder" class=" ">
                                            <input id="ctrl-short_text" data-field="short_text"  value="<?php  echo $data['short_text']; ?>" type="text" placeholder="Enter Short Text"  name="short_text"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-long_text-holder" class=" ">
                                            <textarea placeholder="Enter Long Text" id="ctrl-long_text" data-field="long_text"  rows="5" name="long_text" class=" form-control"><?php  echo $data['long_text']; ?></textarea>
