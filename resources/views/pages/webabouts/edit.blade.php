                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-body-holder" class=" ">
                                            <textarea placeholder="Enter Body" id="ctrl-body" data-field="body"  rows="5" name="body" class=" form-control"><?php  echo $data['body']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-custom-holder" class=" ">
                                            <textarea placeholder="Enter Custom" id="ctrl-custom" data-field="custom"  rows="5" name="custom" class=" form-control"><?php  echo $data['custom']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        </div>
                                    </div>
                                </div>
