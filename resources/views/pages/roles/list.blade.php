                            ...
                            <div class="col">
                                <div id="page-main-content" class="table-responsive">
                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        ...
                                        <?php } ?>
                                        <?php if($can_delete){ ?>
                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal"  href="<?php print_link("roles/delete/$rec_id"); ?>" >
