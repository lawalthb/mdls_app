...
<?php
    ...
    $pageTitle = "Web Blog Categories"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Web Blog Categories</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary btn-block" href="<?php print_link("webblogcategories/add", true) ?>" >
                    <i class="material-icons">add</i>                               
                    Add New Web Blog Category 
                </a>
                <?php } ?>
            </div>
            <div class="col-md-3  " >
