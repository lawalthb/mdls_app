...
<?php
    $pageTitle = "Edit Web Gallery"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Web Gallery</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("webgalleries/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-academic_session_id-holder" class=" ">
                                            <input id="ctrl-academic_session_id" data-field="academic_session_id"  value="<?php  echo $data['academic_session_id']; ?>" type="number" placeholder="Enter Academic Session Id" step="any"  required="" name="academic_session_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-images-holder" class=" ">
                                            <div class="dropzone " input="#ctrl-images" fieldname="images" uploadurl="{{ url('fileuploader/upload/images') }}"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                <input name="images" id="ctrl-images" data-field="images" class="dropzone-input form-control" value="<?php  echo $data['images']; ?>" type="text"  />
