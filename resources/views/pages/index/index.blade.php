        ...
        <div>
            <div class="mb-3">
                <div class="container-fluid" style="background-image: url({{ asset('images/bkg.jpg') }});
                                ...
                                <div>
                                    ...
                                    <form name="loginForm" action="{{ route('auth.login') }}" class="needs-validation form page-form" method="post">
                                        ...
                                        <div class="input-group form-group">
                                            <input placeholder="Username / Email / Phone Number" name="username" required="required" class="form-control" type="text" />
