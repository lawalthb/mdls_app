                        ...
                        <div class="collapse collapse-lg " id="<?php echo $menu_id ?>">
                            ...
                            if (!empty($menus)) {
                                ...
                                foreach ($menus as $menu) {
                                    $count = $menu->num ?? null;
                                    $arr_menu[] = array(
                                        "path" => "classsubjects/add?class_id={$menu->value}",
                                        "label" => $menu->label,
                                        "count" => $count,
                                        "icon" => ''
                                    );
                            ...
                            <div>
                                ...
                                <template id="<?php echo $template_id ?>">
                                    ...
                                    <tr data-row="<?php echo $row ?>" class="input-row">
                                        <input id="ctrl-class_id-row<?php echo $row; ?>" data-field="class_id" value="<?php echo get_value('class_id') ?>" type="hidden" placeholder="Enter Class" list="class_id_list" required="" name="row[<?php echo $row ?>][class_id]" class="form-control " value="<?php
                                        ...
                                        <td>
                                            <div id="ctrl-is_active-row<?php echo $row; ?>-holder" class=" ">
                                                <input id="ctrl-is_active-row<?php echo $row; ?>" data-field="is_active" value="<?php echo get_value('is_active', "Yes") ?>" type="text" placeholder="Enter Is Active" list="is_active_list" required="" name="row[<?php echo $row ?>][is_active]" class="form-control " />
