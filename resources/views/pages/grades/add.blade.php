                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-remarks-holder" class=" ">
                                                <input id="ctrl-remarks" data-field="remarks"  value="<?php echo get_value('remarks') ?>" type="text" placeholder="Enter Remarks"  required="" name="remarks"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
