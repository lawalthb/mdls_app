            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="users-add_staff-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('users.add_staff_store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-password-holder" class="input-group ">
                                                <input id="ctrl-password" data-field="password"  value="<?php echo get_value('password', "$2y$10$iOMlpi7zwljJ2SwAow0doOgizVAgByA3M3ykuEiKICLC5ZO5zVBSm") ?>" type="password" placeholder="Enter Password"  required="" name="password"  class="form-control  password password-strength" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-is_active-holder" class=" ">
                                                <input id="ctrl-is_active" data-field="is_active"  value="<?php echo get_value('is_active') ?>" type="text" placeholder="Enter Is Active"  required="" name="is_active"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-account_status-holder" class=" ">
                                                <input id="ctrl-account_status" data-field="account_status"  value="<?php echo get_value('account_status', "Pending") ?>" type="text" placeholder="Enter Account Status"  name="account_status"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
