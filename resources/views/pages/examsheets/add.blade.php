            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        ...
                        <form id="examsheets-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('examsheets.store') }}" method="post">
                            ...
                            <td>
                                ...
                                <input id="ctrl-exam_score-row<?php echo $row; ?>" data-field="exam_score"  value="<?php echo get_value('exam_score', "0.00") ?>" type="number" placeholder="Enter Exam Score" step="0.1"  required="" name="examsheetperformances[<?php echo $row ?>][exam_score]"  class="form-control " />
                            </div>
                        </td>
                        <td>
                    ...
                    <td>
                        ...
                        <input id="ctrl-remark-row<?php echo $row; ?>" data-field="remark"  value="<?php echo get_value('remark') ?>" type="text" placeholder="Enter Remark (Optional)"  required="" name="examsheetperformances[<?php echo $row ?>][remark]"  class="form-control " />
                    </div>
                </td>
