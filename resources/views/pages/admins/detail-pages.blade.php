    ...
    <div class="master-detail-page card">
        <div class="card-header text-bold h5 p-3 mb-3">Admins Records</div>
        <div class="p-2">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a data-bs-toggle="tab" href="#plans_<?php echo $page_id ?>" class="nav-link active">
                    Admin Plans
                </a>
            </li>
            <li class="nav-item">
...
<div class="tab-content">
    <div class="tab-pane fade show active" id="plans_<?php echo $page_id ?>" role="tabpanel">
    <div class=" ">
        <?php
            $params = ['updated_by' => $rec_id,'show_header' => false]; //new query param
            $query = array_merge(request()->query(), $params);
            $queryParams = http_build_query($query);
            $url = url("plans/index/updated_by/$rec_id?$queryParams");
        ?>
...
<div class=" ">
    <?php
        ...
        $query = array_merge(request()->query(), $params);
        $queryParams = http_build_query($query);
        $url = url("transactions/index/user_id/$rec_id?$queryParams");
    ?>
    <div class="ajax-inline-page" data-url="{{ $url }}" >
        <div class="ajax-page-load-indicator">
            <div class="text-center d-flex justify-content-center load-indicator">
