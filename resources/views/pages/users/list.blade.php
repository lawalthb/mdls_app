                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-balance" > Balance</th>
                                        <th class="td-refer_by" > Refer By</th>
                                        <th class="td-referral_code" > Referral Code</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-refer_by">
                                            <?php echo  $data['refer_by'] ; ?>
                                        </td>
                                        <td class="td-referral_code">
                                            <?php echo  $data['referral_code'] ; ?>
                                        </td>
