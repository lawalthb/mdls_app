...
<?php
    ...
    $pageTitle = "Web Contacts"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Web Contacts</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="webcontacts-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/webcontacts/", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-phone1" > Phone1</th>
                                        <th class="td-phone2" > Phone2</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-email1">
                                            <a href="<?php print_link("mailto:$data[email1]") ?>"><?php echo $data['email1']; ?></a>
                                        </td>
                                        <td class="td-email2">
                                            <a href="<?php print_link("mailto:$data[email2]") ?>"><?php echo $data['email2']; ?></a>
                                        </td>
                                        <td class="td-phone1">
                                            <a href="<?php print_link("tel:$data[phone1]") ?>"><?php echo $data['phone1']; ?></a>
                                        </td>
                                        <td class="td-phone2">
                                            <a href="<?php print_link("tel:$data[phone2]") ?>"><?php echo $data['phone2']; ?></a>
                                        </td>
                                        <td class="td-address">
