...
<?php
    ...
    $pageTitle = "Terms"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Terms</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary btn-block" href="<?php print_link("terms/add", true) ?>" >
...
<div  class="" >
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="terms-list-records">
                        <div class="row gutter-lg ">
                            <div class="col">
                                <div id="page-main-content" class="table-responsive">
                                    <?php Html::page_bread_crumb("/terms/", $field_name, $field_value); ?>
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-masterdetailbtn">
                                                    <a data-page-id="terms-detail-page" class="btn btn-sm btn-secondary open-master-detail-page" href="<?php print_link("terms/masterdetail/$data[id]"); ?>">
        ...
        <div class=" mt-3">
            <div class="row align-items-center justify-content-between">    
                <div class="col-md-auto d-flex">    
                    <?php if($can_delete){ ?>
                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("terms/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
    ...
    <div class="col-12">
        <div class=" ">
            <div id="terms-detail-page" class="master-detail-page"></div>
        </div>
    </div>
    <?php } ?>
</div>
