                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                                        ...
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <div class="fw-bold">
                                                        <a size="sm" class="btn btn-sm btn btn-secondary page-modal" href="<?php print_link("admins/view/$data[user_id]?subpage=1") ?>">
                                    ...
                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <div class="fw-bold">
                                                    <a size="sm" class="btn btn-sm btn btn-secondary page-modal" href="<?php print_link("plans/view/$data[price_settings_id]?subpage=1") ?>">
                                                    <i class="material-icons">visibility</i> <?php echo "Plans Detail" ?>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="bg-light mb-1 card-1 p-2 border rounded">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <small class="text-muted">Callback Url</small>
                                            <div class="fw-bold">
                            ...
                            <div class="col-12">
                                <div class="bg-light mb-1 card-1 p-2 border rounded">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <small class="text-muted">Purpose Id</small>
                                            <div class="fw-bold">
                                                <?php echo  $data['purpose_id'] ; ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
