                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-academic_session_id-holder" class=" ">
                                                <input id="ctrl-academic_session_id" data-field="academic_session_id"  value="<?php echo get_value('academic_session_id') ?>" type="number" placeholder="Enter Academic Session Id" step="any"  required="" name="academic_session_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
