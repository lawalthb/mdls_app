...
use App\Http\Requests\Usersadd_staffRequest;
...
$query->where("account_status", "=" , "active");
	...
	function add_staff_store(Usersadd_staffRequest $request){
		...
		$staffdetailsValidator = validator()->make($staffdetailsPostData, ["gender" => "required",
				"class_id" => "nullable",
				"address" => "nullable|string",
		...
		$staffdetailsModeldata = $this->normalizeFormData($staffdetailsValidator->valid());

		if( array_key_exists("files", $staffdetailsModeldata) ){
			//move uploaded file from temp directory to destination directory
