                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-class_id-holder" class=" ">
                                                    <input id="ctrl-class_id" data-field="class_id"  value="<?php echo get_value('class_id', "0") ?>" type="number" placeholder="Enter Class Id" step="any"  name="staffdetails[class_id]"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-guarantor_details-holder" class=" ">
                                                    <textarea placeholder="Enter Guarantor Details" id="ctrl-guarantor_details" data-field="guarantor_details"  rows="5" name="staffdetails[guarantor_details]" class=" form-control"><?php echo get_value('guarantor_details') ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-other_info-holder" class=" ">
                                                    <textarea placeholder="Enter Other Info" id="ctrl-other_info" data-field="other_info"  rows="5" name="staffdetails[other_info]" class=" form-control"><?php echo get_value('other_info') ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">[html-lang-0130]</div>-->
                                                </div>
                                            </div>
                                        </div>
