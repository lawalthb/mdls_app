    ...
    <div class="master-detail-page card">
        <div class="card-header text-bold h5 p-3 mb-3">Sessions Records</div>
        <div class="p-2">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a data-bs-toggle="tab" href="#examsettings_<?php echo $page_id ?>" class="nav-link active">
                    Session Exam Settings
                </a>
            </li>
        </ul>
    </div>
    <div class="tab-content">
        ...
        <div class=" ">
            <?php
                $params = ['session_id' => $rec_id,'show_header' => false]; //new query param
                $query = array_merge(request()->query(), $params);
                $queryParams = http_build_query($query);
                $url = url("examsettings/index/session_id/$rec_id?$queryParams");
            ?>
