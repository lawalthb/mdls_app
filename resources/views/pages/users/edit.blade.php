                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-balance-holder" class=" ">
                                            <input id="ctrl-balance" data-field="balance"  value="<?php  echo $data['balance']; ?>" type="number" placeholder="Enter Balance" step="0.1"  required="" name="balance"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-refer_by-holder" class=" ">
                                            <input id="ctrl-refer_by" data-field="refer_by"  value="<?php  echo $data['refer_by']; ?>" type="text" placeholder="Enter Refer By"  name="refer_by"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-referral_code-holder" class=" ">
                                            <input id="ctrl-referral_code" data-field="referral_code"  value="<?php  echo $data['referral_code']; ?>" type="text" placeholder="Enter Referral Code"  required="" name="referral_code"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
