...
<?php
    $pageTitle = "Add New Web Slider"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Web Slider</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="websliders-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('websliders.store') }}" method="post">
                            @csrf
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-mobile_image-holder" class=" ">
                                                <div class="dropzone " input="#ctrl-mobile_image" fieldname="mobile_image" uploadurl="{{ url('fileuploader/upload/mobile_image') }}"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                    <input name="mobile_image" id="ctrl-mobile_image" data-field="mobile_image" class="dropzone-input form-control" value="<?php echo get_value('mobile_image') ?>" type="text"  />
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                    <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-caption-holder" class=" ">
                                                <input id="ctrl-caption" data-field="caption"  value="<?php echo get_value('caption') ?>" type="text" placeholder="Enter Caption"  name="caption"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
